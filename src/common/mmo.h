...
#define SCRIPT_VARNAME_LENGTH 32 ///< Maximum length of a script variable's name excluding affixes and NULL-terminator.
...
#define SCRIPT_STRING_VAR_LENGTH 255 ///< Maximum length of strings stored in permanent script variables excluding NULL-terminator.
