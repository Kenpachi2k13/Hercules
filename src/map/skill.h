...
struct skill_interface {
	...
	int (*get_nk) (int skill_id, struct block_list *source, struct block_list *target);
	int (*get_max) (int skill_id);
	int (*get_range) (int skill_id, int skill_lv, struct block_list *source, struct block_list *target);
	int (*get_range2) (struct block_list *bl, int skill_id, int skill_lv, struct block_list *target);
	...
	int (*get_mhp) (int skill_id, int skill_lv, struct block_list *source, struct block_list *target);
	int (*get_msp) (int skill_id, int skill_lv, struct block_list *source, struct block_list *target);
	...
	int (*get_item_index) (int skill_id, int skill_lv, struct block_list *source, struct block_list *target);
	...
	int (*get_castnodex) (int skill_id, int skill_lv, struct block_list *source, struct block_list *target);
	int (*get_delaynodex) (int skill_id, int skill_lv, struct block_list *source, struct block_list *target);
	...
	int (*get_unit_flag) (int skill_id, struct block_list *source, struct block_list *target);
