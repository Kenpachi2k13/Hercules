...
static bool read_mercenarydb_sub(char *str[], int columns, int current)
{
	...
	mstatus->str = cap_value(atoi(str[11]), SHRT_MIN, SHRT_MAX);
	mstatus->agi = cap_value(atoi(str[12]), SHRT_MIN, SHRT_MAX);
	mstatus->vit = cap_value(atoi(str[13]), SHRT_MIN, SHRT_MAX);
	mstatus->int_ = cap_value(atoi(str[14]), SHRT_MIN, SHRT_MAX);
	mstatus->dex = cap_value(atoi(str[15]), SHRT_MIN, SHRT_MAX);
	mstatus->luk = cap_value(atoi(str[16]), SHRT_MIN, SHRT_MAX);
